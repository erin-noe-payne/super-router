...
class App {
   ...
   * });
   *
   * @param {Object|Function} route - The middleware route. If a function is provided, it will be
   *  used as the handler.
   * @param {String} [route.path='*all'] - The path pattern to which this middleware will be applied
   * @param {String} [route.method='*'] - The method to which this middleware will be applied
   * @param {Function} route.handler - The middleware handler
